...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/Starisian-Technologies/sparxstar-boson"
    }
  ],
  "require": {
...
git clone https://github.com/Starisian-Technologies/sparxstar-boson.git
```

Or download and extract the ZIP file to `wp-content/mu-plugins/sparxstar-boson/`
...
```bash
composer update starisian-technologies/sparxstar-boson
```
...
3. Replace files in `wp-content/mu-plugins/sparxstar-boson/`
...
```bash
composer remove starisian-technologies/sparxstar-boson
```
...
2. Delete `wp-content/mu-plugins/sparxstar-boson/` directory
...
- GitHub Issues: https://github.com/Starisian-Technologies/sparxstar-boson/issues
- Documentation: https://github.com/Starisian-Technologies/sparxstar-boson
